...
main: starting coroutine with argument '123'
coro: starting with '123'
coro: yielding '999'
main: coroutine yielded '999'
main: calling coroutine the last time with '456'...
coro: got '456' from main
coro: param is still '123'
coro: returning '777'
main: coroutine finished with '777'
*/
